    ...
    return (
        <div className="contenedor-principal">
            <div className="escenario">
                <div className="cartel-calle">ABBEY ROAD NW8</div>
            ...
            <div className="controles">
                <button className="btn-interfaz" onClick={alternarColor}>Siguiente Color</button>
                <button className="btn-interfaz especial" onClick={gestionarModoEspecial}>
